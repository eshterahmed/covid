...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [10143,10929,11719,12425,13134,13770,14657,15691,16660,17822,18823,20065,20995,22268,23870,25121,Activecases, Activecases + 10],
    },
    {
      data:[182,183,186,199,206,214,228,239,250,269,283,298,314,328,349,370,386],
      label: "Deaths ",
      lineTension: 0.2,
