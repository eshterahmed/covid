...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [4187,4689,4998,5416,5913,6462,7103,7667,8238,9455,10143,10929,11719,12425,13134,13770,Activecases, Activecases + 10],
    },
    {
      data:[140,145,152,155,163,168,170,175,177,182,183,186,199,206,214,228],
      label: "Deaths ",
      lineTension: 0.2,
