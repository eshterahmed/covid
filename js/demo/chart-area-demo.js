...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [123,164,218,330,424,482,621,803,1012,1231,1572,1838,2144,2456,2948,Activecases, Activecases + 10],
    },
    {
      data:[12,17,20,21,27,30,34,39,46,50,60,75,84,91,101,110],
      label: "Deaths ",
      lineTension: 0.2,
