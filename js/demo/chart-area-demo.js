...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [70,88, 123,164,218,330,424,482,621,803,1012,1231,1572,1838,2144,Activecases, Activecases + 10],
    },
    {
      data:[8,9,12,17,20,21,27,30,34,39,46,50,60,75,84,91],
      label: "Deaths ",
      lineTension: 0.2,
