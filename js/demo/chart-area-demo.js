...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [1012,1231,1572,1838,2144,2456,2948,3382,3772,4187,4689,4998,5416,5913,6462,Activecases, Activecases + 10],
    },
    {
      data:[46,50,60,75,84,91,101,110,120,127,131,140,145,152,155,163],
      label: "Deaths ",
      lineTension: 0.2,
