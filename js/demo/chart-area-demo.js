...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [330,424,482,621,803,1012,1231,1572,1838,2144,2456,2948,3382,3772,4187,Activecases, Activecases + 10],
    },
    {
      data:[21,27,30,34,39,46,50,60,75,84,91,101,110,120,127,131],
      label: "Deaths ",
      lineTension: 0.2,
