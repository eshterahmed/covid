...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [6462,7103,7667,8238,9455,10143,10929,11719,12425,13134,13770,14657,15691,16660,17822,18823,Activecases, Activecases + 10],
    },
    {
      data:[163,168,170,175,177,182,183,186,199,206,214,228,239,250,269,283,298],
      label: "Deaths ",
      lineTension: 0.2,
